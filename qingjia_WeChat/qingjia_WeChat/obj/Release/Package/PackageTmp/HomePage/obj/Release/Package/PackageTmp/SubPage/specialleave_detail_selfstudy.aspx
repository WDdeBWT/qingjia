...
<body>
    <div id="top" class="index_top" style="background:white;">
        <a href="specialleave.html"><img src="images/icon_back_.png" style="height:40%; margin-left:2%; margin-top:4%;" /></a>
    ...
    <div class="weui-cells weui-cells_form">
        ...
        <div class="schoolleavedetail_main">
            ...
            <div class="weui-cell">
                ...
                <div class="weui-cell__bd">
                    <input class="weui-input" type="number" placeholder="早晚自习请假" />
                </div>
            </div>
            <div class="weui-cell">
