<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="schoolleave_detail_holiday.aspx.cs" Inherits="qingjia_WeChat.SubPage.WebForm6" %>
...
<body>
    ...
    <div class="weui-cells weui-cells_form" runat="server">
        <div class="change">
                <a href="schoolleave_detail_short.aspx"><img src="images/schoolleave_short2.png" style="width:25%; margin-left:12.5%; margin-top:5%;" /></a>
                <a href="schoolleave_detail_long.aspx"><img src="images/schoolleave_long2.png" style="width:25%; margin-left:37.5%;" /></a>
                <a href="schoolleave_detail_holiday.aspx"><img src="images/schoolleave_holiday1.png" style="width:25%; margin-left:62.5%;" /></a>
         </div>

        <div style="display:none; margin-top:30%;" runat="server" id="end">
            <p style="margin-bottom:30%; text-align:center; font-weight:bold; color:red;">节假日请假已截止！</p>
        </div>
         ...
         <div class="schoolleavedetail_main" style="display:block;" runat="server" id="index">
             <input class="weui-input" type="text" style="color:red; margin-left:18px; font-size:15px;" runat="server" disabled="disabled" id="txtError" value="" />
                ...
                <div class="weui-cell" style="color:rgb(169,169,169);">
                    ...
                    <div class="weui-cell__bd">
                        <label class="weui-label1" id="Label_LeaveType" runat="server" style="color:rgb(169,169,169);">节假日请假</label>
                    </div>
                </div>
                <div class="weui-cell">
             ...
             <div class="weui-cell">
                 <div class="weui-cell__hd"><label class="weui-label2">离校方式</label></div>
                 <div class="weui-cell__bd">
                     <input class="weui-input" runat="server" type="text" id="txt_leave_way" placeholder="请具体到车次" />
                 </div>
             </div>
             <div class="weui-cell">
                 <div class="weui-cell__hd"><label class="weui-label2">返校方式</label></div>
                 <div class="weui-cell__bd">
                     <input class="weui-input" runat="server" type="text" id="txt_back_way" placeholder="请具体到车次" />
                 </div>
             </div>
             <div class="weui-cell">
                    <div class="weui-cell__hd"><label class="weui-label2">请假去向</label></div>
                       <div class="weui-cells weui-cells_radio" style="color:rgb(169,169,169);">
                            <label class="weui-cell weui-check__label" for="x31">
                                <div class="weui-cell__bd">
                                    <p>回家</p>
                                </div>
                                <div class="weui-cell__ft">
                                    <input type="radio" runat="server" class="weui-check" name="radio3" id="x31" checked="true" />
                            ...
                            <label class="weui-cell weui-check__label" for="x32">
                                ...
                                <div class="weui-cell__ft">
                                    <input type="radio" runat="server" name="radio3" class="weui-check" id="x32" >
                                    <span class="weui-icon-checked"></span>
                                </div>
                            </label>
                            <label class="weui-cell weui-check__labe3" for="x33">
                                ...
                                <div class="weui-cell__ft">
                                    <input type="radio" runat="server" name="radio3" class="weui-check" id="x33" >
                                    <span class="weui-icon-checked"></span>
                                </div>
                            </label>
                           <label class="weui-cell weui-check__labe3" for="x34">

                                <div class="weui-cell__bd">
                                    <p>其他</p>
                                </div>
                                <div class="weui-cell__ft">
                                    <input type="radio" runat="server" name="radio3" class="weui-check" id="x34" />
                                    <span class="weui-icon-checked"></span>
                                </div>
                            </label>
                        </div>
             ...
             <div class="weui-cell">
                 <div class="weui-cell__hd"><label class="weui-label2">离校去向地址</label></div>
