<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="modify_detail.aspx.cs" Inherits="qingjia_WeChat.SubPage.modify_detail" %>
    ...
    <div class="modify_detail" >        
            <div class="weui-cells weui-cells_form">
                ...
                <div class="weui-cell">
                    ...
                    <div class="weui-cell__bd">
                        <input class="weui-input" type="password" placeholder="请确认新密码" />
                    </div>
                </div>
                             
                <div class="page__bd page__bd_spacing">
                    <br /><br />
                    <a href="modify_succeed.aspx" class="weui-btn weui-btn_primary">提交</a>
                    <br />
                </div>
                <div class="page__ft">
