...
<body>
    ...
    <div class="weui-cells weui-cells_form">
        <div class="change">
                ...
                <a href="schoolleave_detail_long.aspx"><img src="images/schoolleave_long1.png" style="width:25%; margin-left:37.5%;" /></a>
         ...
         <div class="schoolleavedetail_main">
             <input class="weui-input" type="text" style="color:red; margin-left:18px; font-size:15px;" runat="server" disabled="disabled" id="txtError" value="" />
                ...
                <div class="weui-cell" style="color:rgb(169,169,169);">
                    ...
                    <div class="weui-cell__bd">
                        <label class="weui-label1" id="Label_LeaveType" runat="server" style="color:rgb(169,169,169);">长期请假</label>
                    </div>
                </div>
                <div class="weui-cell">
